...
This document defines the `PRD_STANDARD_FINDINGS_V1` payload emitted when the skill runs a PRD quality assessment. One payload is produced in the same invocation as the paired `PRD_QUALITY_REPORT_V1` payload.
