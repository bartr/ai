...
This document is the entrypoint for the PRD quality format specifications. It is the single source of truth for the YAML payload contracts produced and consumed during PRD quality assessment.
